// PROTOTYPE ONLY. Fixture for the read-only canvas stories: the tree-editor story's complex
// workflow, once as code-managed and once as a GUI workflow for comparison.

import type { HogFlow, HogFlowAction } from '../types'

export const WORKFLOW_ID = 'storybook-code-managed-workflow'

const BASE_WORKFLOW: HogFlow = {
    id: WORKFLOW_ID,
    team_id: 1,
    version: 7,
...
export const CODE_MANAGED_WORKFLOW: HogFlow = {
    ...BASE_WORKFLOW,
    managed_by: 'code',
...
export const EDITABLE_WORKFLOW: HogFlow = {
    ...BASE_WORKFLOW,
    id: 'storybook-editable-workflow',
    managed_by: 'gui',
}
